            ...
            <div>
                <footer className="text-white text-center text-lg-start" style={{backgroundColor: '#23242a'}}>
                    ...
                    <div className="container p-4">
                        ...
                        <div className="row mt-4">
                            ...
                            <div className="col-lg-4 col-md-12 mb-4 mb-md-0">
                                ...
                                <div className="mt-4">
                                    <Button type="button" className="btn btn-floating btn-warning btn-lg"><i className="bi-facebook"></i></Button>


                                    <Button type="button" className="btn btn-floating btn-warning btn-lg"><i className="bi-dribbble"></i></Button>

                                    <Button type="button" className="btn btn-floating btn-warning btn-lg"><i className="bi-twitter"></i></Button>

                                    <Button type="button" className="btn btn-floating btn-warning btn-lg"><i className="bi-google"></i></Button>
                            ...
                            <div className="col-lg-4 col-md-6 mb-4 mb-md-0">
                                ...
                                <div className="form-outline form-white mb-4">
                                    ...
                                    <label className="form-label"  style={{marginLeft: '0px'}}>Search</label>
                    ...
                    <div className="text-center p-3" style={{backgroundColor: 'rgba(0, 0, 0, 0.2)'}}>
                        © 2020 Copyright: Bruno Freire Araújo
                    </div>
